								...
								<div class="edit_wrapper">
									...
									<ul class="edit_area weebly-content-area weebly-area-active" style="margin-top: 13px;">
										...
										<li class="comp-resize comp-rotate wsite-text" style="width: 150px; height: 62px; left: 116px; top: 16px; z-index: 9;">
											<div class="element-box ani resize" style="width: 150px; height: 62px; z-index: 9; left: 116px; top: 16px; line-height: 1; transform: none;" swiper-animate-effect="fadeInRight" swiper-animate-duration="1s" swiper-animate-delay="0.4s">
												<div class="element-box-contents" style="width: 100%; height: 100%;">
													<div class="element comp_paragraph editable-text" style="cursor: default; width: 150px; height: 62px;">
														<font color="#ffffff" size="2"><span style="line-height: 13px;"></span></font><span style="color: rgb(255, 255, 255); font-size: small; line-height: 1; background-color: initial;">{{new_val[4][0].content}}</span></div>
												</div>
											</div>
										</li>
										<li class="comp-resize comp-rotate wsite-text" style="width: 138px; height: 62px; left: 44px; top: 102px; z-index: 10;">
											<div class="element-box ani resize" style="width: 138px; height: 62px; z-index: 10; left: 44px; top: 102px; line-height: 1; transform: none;" swiper-animate-effect="fadeInLeft" swiper-animate-duration="1s" swiper-animate-delay="0.8s">
												<div class="element-box-contents" style="width: 100%; height: 100%;">
													<div class="element comp_paragraph editable-text" style="cursor: default; width: 138px; height: 62px;">
														<div style="text-align: left;"><span style="line-height: 13px; color: rgb(255, 255, 255); font-size: small; background-color: initial;">{{new_val[4][1].content}}</span></div>
													</div>
												</div>
											</div>
										</li>
										<li class="comp-resize comp-rotate wsite-text" style="width: 144px; height: 62px; left: 123px; top: 193px; z-index: 11;">
											<div class="element-box ani resize" style="width: 144px; height: 62px; z-index: 11; left: 123px; top: 193px; line-height: 1; transform: none;" swiper-animate-effect="fadeInRight" swiper-animate-duration="1s" swiper-animate-delay="1.2s">
												<div class="element-box-contents" style="width: 100%; height: 100%;">
													<div class="element comp_paragraph editable-text" style="cursor: default; width: 144px; height: 62px;">
														<font color="#ffffff" size="2"><span style="line-height: 13px;">{{new_val[4][2].content}}</span></font>
													</div>
												</div>
											</div>
										</li>
										<li class="comp-resize comp-rotate wsite-text" style="width: 136px; height: 86px; left: 53px; top: 294px; z-index: 12;">
											<div class="element-box ani resize" style="width: 136px; height: 86px; z-index: 12; left: 53px; top: 294px; line-height: 1; transform: none;" swiper-animate-effect="fadeInLeft" swiper-animate-duration="1s" swiper-animate-delay="1.6s">
												<div class="element-box-contents" style="width: 100%; height: 100%;">
													<div class="element comp_paragraph editable-text" style="cursor: default; width: 136px; height: 86px;">
														<font color="#ffffff" size="2"><span style="line-height: 13px;">{{new_val[4][3].content}}</span></font>
													</div>
												</div>
											</div>
										</li>
										<li class="comp-resize comp-rotate wsite-text" style="width: 139px; height: 62px; left: 119px; top: 392px; z-index: 13;">
											<div class="element-box ani resize" style="z-index: 13; width: 139px; height: 62px; left: 119px; top: 392px; line-height: 1; transform: none;" swiper-animate-effect="fdeInRight" swiper-animate-duration="1s" swiper-animate-delay="2s">
												<div class="element-box-contents" style="width: 100%; height: 100%;">
													<div class="element comp_paragraph editable-text" style="cursor: default; width: 139px; height: 62px;">
														<font color="#ffffff" size="2"><span style="line-height: 13px;">{{new_val[4][4].content}}</span></font>
													</div>
												</div>
											</div>
										</li>
